...
//Sierra Nevada Subsections start with M261, Southern California subsections start with M262
var sierra = usfs.filter(//Sierra Nevada
                         ...
                         //ee.Filter.eq('MAP_UNIT_S', 'M261Ev'), //Was removed before
                         //ee.Filter.eq('MAP_UNIT_S', 'M261Et'), //Was removed before
                         //Southern California
...
var full_data = ee.Image(PET_4yr_2002.select([0],['PET_4yr_2002'])
                             ...
                             .addBands(PET_4yr_2009.select([0],['PET_4yr_2009']))
...
//Original Band Names
                    .select(['PET_4yr_2002_mean', 'PET_4yr_2009_mean', 'PET_4yr_2015_mean','spi48_09_2002_mean','spi48_09_2015_mean','veg_type_2001_mode',
...
//New Band Names
['PET_4yr_2002', 'PET_4yr_2009','PET_4yr_2015','spi48_09_2002','spi48_09_2015','veg_type_2001',
...
var feature_all = download.makeFeature(full, socal, 300, 1e16, 16);
...
Export.table.toDrive({collection: feature_all,
                      description: 'Regression_all_socal_300m_v33',
