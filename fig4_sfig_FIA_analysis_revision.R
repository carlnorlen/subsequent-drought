...
p2_texta <- data.frame(label = c("a", "abc", "cd", "cd", "cd", "cd", "cd", "cd", "cd", "cd",
                       ...
                       y     = c(2.5, 1.3, 0.55, 0.4, 0.28, 0.5, 0.28, 0.22, 0.4, 0.14, 
                                 0.24, 0.2, 0.14, 0.14, 0.16, 1.55, 1.6, 0.27, 0.14, 0.44),
...
ggsave(filename = 'SFig6_basal_area_boxplot_revised.png', height=14, width=16, units = 'cm', dpi=900)
